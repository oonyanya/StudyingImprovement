...
namespace HybridWebView
{
    public partial class HybridWebView : WebView
    {
        ...
        public event Func<HybridWebViewProxyEventArgs, Task>? RequestReceived;
        public virtual async Task OnRequest(HybridWebViewProxyEventArgs args)
        {
            if (RequestReceived != null)
                await RequestReceived(args);
        }
